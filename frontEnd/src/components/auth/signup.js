const AuthSignupContent = () => {
  return `
  <h2 class="font-bold text-2xl">Create Your Account</h2>
                <p class="text-text-secondary text-sm">Join Cinevo and start exploring</p>
                ...
                <form class="mt-6">
                    ...
                    <div>
                        <div
                            class="relative mt-2 flex items-center bg-input-bg text-text-secondary border-2 border-input-border/50 rounded-xl h-14 focus-within:border-input-border-focus transition-colors duration-300">
                            <svg class="absolute size-5 left-2 bottom-0 top-0 my-auto"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="email">
                                <g>
                                    <path
                                        d="M19 4H5a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3zm-.67 2L12 10.75 5.67 6zM19 18H5a1 1 0 0 1-1-1V7.25l7.4 5.55a1 1 0 0 0 .6.2 1 1 0 0 0 .6-.2L20 7.25V17a1 1 0 0 1-1 1z"
                                        fill="currentColor"></path>
                    ...
                    <div
                        ...
                        <input
                            ...
                            placeholder="Create a password" type="text">
                        <button
                ...
                <p class="text-xs mt-10 text-center">Already have an account?<span
                        class="ml-1.5 text-cta-primary hover:text-cta-hover transition-colors duration-300 cursor-pointer">Login</span>
                </p>
  `;
};
