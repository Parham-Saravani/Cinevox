const trailerEl = document.querySelector(".page-trailer");
...
const setLoaderToTrailer = (trailer) => {
  trailerEl.setAttribute("src", `public/videos/${trailer}`);

  trailerEl.className += " bg-gray-900 animate-pulse";
  trailerEl.addEventListener("loadeddata", () => {
    trailerEl.classList.remove("bg-gray-900");
    trailerEl.classList.remove("animate-pulse");
    document
...
export default setLoaderToTrailer;
